...
startInstr = GetLabelAddress("LOOP1",  buildSrc + "/bl2u/bl2u.dump") - 14
populateInstr = GetLabelAddress("LOOP2",  buildSrc + "/bl2u/bl2u.dump") - 2
endInstr = GetLabelAddress("ENDTEST",  buildSrc + "/bl2u/bl2u.dump")
memoryReg = "r6"
statusFlagReg = "r5"
