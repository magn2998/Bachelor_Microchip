...
startInstr = GetLabelAddress("ADDRLOOP1",  buildSrc + "/bl2u/bl2u.dump") - 10;
populateInstr = GetLabelAddress("ADDRLOOP2",  buildSrc + "/bl2u/bl2u.dump") - 2
endInstr = GetLabelAddress("ADDRENDTEST",  buildSrc + "/bl2u/bl2u.dump")
memoryReg = "r12"
statusFlagReg = "r5"
